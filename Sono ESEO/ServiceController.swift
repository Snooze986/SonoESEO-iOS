...
class ServiceController: UIViewController{
    ...
    @IBOutlet weak var material: UIView!
    ...
    override func viewDidLoad() {
        ...
        lblPlace.text = Content.activity!.place ?? ActivitiesConstants.EMPTY_FIELD
    }
    ...
    @IBAction func switchView(sender: UISegmentedControl) {
        if sender.selectedSegmentIndex == 0 {
            ...
            UIView.animate(withDuration: 0.2, animations: {
                ...
                self.material.alpha = 1
            })
        }
    }
    
    // This function reinitialize the service variable and dismiss the current Controller.
